...
async function comparePaperAndCode(pdfPath, zipPath, outputDir, runNumber, customPrompt = null, apiKey = null) {
    ...
    try {
        ...
        const response = await anthropic.messages.create({
            ...
            max_tokens: 20000, //Configure max and thinking tokens as needed
            thinking: {
                type: "enabled",
                budget_tokens: 16000
            },
        ...
        // Get Claude's response text (fixed for thinking mode)
        let result;
...
if (require.main === module) {
    program
        ...
        .option('-o, --output-dir <path>', 'Directory to save output files', './CS2 Results Output/Opus 4') // Configure this to your desired folder
